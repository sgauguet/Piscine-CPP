...
ScavTrap::ScavTrap(void) : ClapTrap("Jane", 100, 100, 50, 50, 1, 20, 15, 3), _small_challenge(2), _medium_challenge(7), _big_challenge(15) {
	std::cout << "ScavTrap " << this->_name << " is born." << std::endl;
	return ;
}

ScavTrap::ScavTrap(std::string name) : ClapTrap(name, 100, 100, 50, 50, 1, 20, 15, 3), _small_challenge(2), _medium_challenge(7), _big_challenge(15) {
